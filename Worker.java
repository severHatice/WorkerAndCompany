...
public class Worker extends Data{
	...
	void objeOlustur() {
		...
		//for (int i = 0; i < data.isimler.size(); i++) {
			Worker worker=new Worker(data.isimler.get(0), data.Soyisimler.get(0), data.idler.get(0), data.sirketler.get(0), data.departmanlar.get(0), 
					data.isimler.get(0).toLowerCase() +"."+ data.Soyisimler.get(0).toLowerCase() +"@"+data.sirketler.get(0).toLowerCase()+".com");
